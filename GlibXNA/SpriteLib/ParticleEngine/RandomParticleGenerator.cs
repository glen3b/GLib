...
namespace Glib.XNA.SpriteLib.ParticleEngine
{
    ...
    public class RandomParticleGenerator : IParticleGenerator
    {
        ...
        public RandomParticleGenerator(SpriteBatch batch, params Texture2D[] textures)
        {
            ...
            _textures = new Collection<Texture2D>(textures);
            _random = new Random();
            Pool = new ParticlePool(batch);
        }

        private Collection<Texture2D> _textures;
        ...
        /// </summary>
        public Collection<Texture2D> Textures
        {
        ...
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709", Justification = "Generic parameters cannot be passed across the network without using reflection.")]
